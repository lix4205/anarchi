...
syst&egrave;me seront pos&eacute;es. <br />
	...
	<ul class="opts_list">
		...
		<ul class="opts_list">
			...
			<li style="list-style-type:none">Use an alternate config file for pacman</li>
			<li class="opt">-d</li>
			<li style="list-style-type:none">Allow installation to a non-mountpoint directory</li>
			<li class="opt">-G</li>
			<li style="list-style-type:none">Avoid copying the host's pacman keyring to the target</li>
			<li class="opt">-i</li>
			<li style="list-style-type:none">Avoid auto-confirmation of package selections</li>
			<li class="opt">-M</li>
			<li style="list-style-type:none">Avoid copying the host's mirrorlist to the target</li>
			<!-- Common options-->
			<li class="opt">-a <span>&lt;arch&gt;</span></li>
			<li style="list-style-type:none">Architecture du processeur (x64/i686)</li>
			<li class="opt">-n <span>&lt;net_pref&gt;</span></li>
			<li style="list-style-type:none">Au choix: dhcpcd/dhcpcd@&lt;inet_addr&gt;,nm/networmanager<br>
			...
			<li style="list-style-type:none">Pilote carte graphique parmi intel,nouveau,radeon/ati,virtualbox/vb,nvidia/nvidia304/nvidia340,all ( all pour tout les pilotes)</li>
			<li class="opt">-e <span>&lt;desk_env&gt;</span></li>
			<li style="list-style-type:none">Environnement de bureau parmi plasma,lxqt,xfce,lxde,mate,gnome</li>
			<li class="opt">-h <span>&lt;hostname&gt;</span></li>
			<li style="list-style-type:none">Nom de la machine</li>
			<li class="opt">-u <span>&lt;username&gt;</span></li>
			<li style="list-style-type:none">Login utilisateur</li>			
			<!-- Langage/Location options-->
			<li class="opt">-k <span>&lt;kbd_conf&gt;</span></li>
			<li style="list-style-type:none">Disposition du clavier en console</li>
			<li class="opt">-K <span>&lt;xkbd_conf&gt;</span></li>
			<li style="list-style-type:none">Disposition du clavier sous X</li>
			<li class="opt">-z <span>&lt;Zone/SousZone&gt;</span></li>
			<li style="list-style-type:none">Fuseau horaire &agrave; suivre</li>			
			<!-- Advanced -->
			<li class="opt">-l <span>&lt;/dev/sdX&gt;</span></li>
			<li style="list-style-type:none">Installe le chargeur de d&eacute;marrage grub sur le p&eacute;ripherique /dev/sdX.</li>
			<li class="opt"> -c <span>&lt;cache_paquets&gt;</span></li>
			<li style="list-style-type:none">Utilisation des paquets contenu dans le dossier &lt;cache_paquets&gt;</li>			
			<!-- Other (Printing, Bluetooth, usefull softwares)-->
			<li class="opt">-p</li>
			<li style="list-style-type:none">Gestion imprimante ( cups )</li>
			<li class="opt">-H</li>
			<li style="list-style-type:none">Gestion imprimante HP ( cups + hplip )</li>
			<li class="opt">-b</li>
			<li style="list-style-type:none">Gestion du bluetooth ( bluez bluez-utils )</li>
			<li class="opt">-L</li>
			<li style="list-style-type:none">Installation de libreoffice</li>
			<li class="opt">-T</li>
			<li style="list-style-type:none">Installation de thunderbird</li>			
			<li class="opt"><br />-t</li>
			<li style="list-style-type:none">Test mode, commands are in /tmp/anarchi_command</li>
			<li class="opt">-h</li>
			<li style="list-style-type:none">Print this help message</li>
		</ul>
